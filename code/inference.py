...
def inference(args, datasets):
    ...
    model.generate_batch(non_cs_inference_tasks, save_callback=save_callback, max_workers=args.batch)
    
    print("Inference for CS subject")
    model.generate_batch_N(cs_inference_tasks, N=5, save_callback=save_callback, max_workers=args.batch)
